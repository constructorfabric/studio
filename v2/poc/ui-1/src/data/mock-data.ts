...
export const MOCK_OBJECTS: StudioObject[] = [
  ...
  // Component Registry
  {
    ...
    links: [
      { targetId: 'design-001', kind: 'implements' },
      { targetId: 'pr-001', kind: 'derived_from' },
    ],
  },
  {
    id: 'comp-payment-gw',
    ...
    links: [{ targetId: 'comp-billing', kind: 'references' }],
  },
  ...
  },
  {
    ...
    createdAt: '2023-06-01T00:00:00Z',
    updatedAt: '2024-01-01T00:00:00Z',
    links: [{ targetId: 'team-platform', kind: 'references' }],
  },
  ...
  },
  {
    ...
    createdAt: '2023-06-01T00:00:00Z',
    updatedAt: '2024-01-15T00:00:00Z',
    links: [{ targetId: 'team-billing', kind: 'references' }],
  },
  ...
  // Releases
  {
    ...
    updatedAt: '2024-01-18T00:00:00Z',
    links: [
      { targetId: 'build-001', kind: 'derived_from' },
    ],
  },
  {
    id: 'rel-1.3.0-rc1',
  ...
  // Deployments
  {
    ...
    typeId: 'deployment',
    tenantId: 'tenant-acme',
    title: 'billing-service → staging @ v1.2.0',
    state: 'done',
    validationStatus: 'pass',
    stalenessScore: 0.0,
    ...
    links: [
      { targetId: 'rel-1.2.0', kind: 'derived_from' },
      { targetId: 'env-staging', kind: 'references' },
      { targetId: 'comp-billing', kind: 'references' },
    ],
  },
  {
    id: 'deploy-002',
    typeId: 'deployment',
    tenantId: 'tenant-acme',
    title: 'billing-service → prod @ v1.2.0',
    state: 'in_progress',
    validationStatus: 'pending',
    stalenessScore: 0.0,
    ...
    links: [
      { targetId: 'rel-1.2.0', kind: 'derived_from' },
      { targetId: 'env-prod', kind: 'references' },
      { targetId: 'comp-billing', kind: 'references' },
      { targetId: 'deploy-001', kind: 'supersedes' },
    ],
  },
]
...
export const NODE_POSITIONS: Record<string, { x: number; y: number }> = {
  ...
  // New SDLC types — components, releases, environments, deployments, teams, people
  'comp-billing':    { x: 2260, y: 100 },
  'comp-payment-gw': { x: 2260, y: 280 },
  'rel-1.2.0':       { x: 2260, y: -120 },
  'rel-1.3.0-rc1':   { x: 2260, y: -300 },
  'env-staging':     { x: 2560, y: 100 },
  'env-prod':        { x: 2560, y: 280 },
  'deploy-001':      { x: 2860, y: 100 },
  'deploy-002':      { x: 2860, y: 280 },
  'team-platform':   { x: 2560, y: -120 },
  'team-billing':    { x: 2560, y: -300 },
  'person-alice':    { x: 2860, y: -120 },
  'person-bob':      { x: 2860, y: -300 },
}
...
export const WORKER_DEFS: WorkerDef[] = [
  ...
  },
  {
    ...
    description: 'Deploys a release to the staging environment with smoke tests.',
    requiresAutomationGate: true,
    category: 'ops',
    profile: 'on_demand',
  ...
  },
  {
    ...
    description: 'Promotes a staging-validated release to production. Requires tech lead approval.',
    requiresAutomationGate: true,
    category: 'ops',
    profile: 'on_demand',
  ...
  },
  {
    ...
    description: 'Rolls back the current deployment to the previous stable release.',
    requiresAutomationGate: true,
    category: 'ops',
    profile: 'on_demand',
  ...
  },
  {
    ...
    label: 'Component Impact Analysis',
    description: 'Analyzes which components are affected by a proposed change.',
    requiresAutomationGate: false,
    category: 'quality',
    profile: 'analyzer',
  ...
  },
  {
    ...
    label: 'Design Review',
    description: 'LLM-based design review that emits a conformance score (0.0–1.0) and a list of findings (critical/major/minor) against the PRD and ADR constraints. Non-binary — always produces findings regardless of score.',
    requiresAutomationGate: false,
    category: 'quality',
    profile: 'analyzer',
  ...
  },
  {
    ...
    label: 'Code Review',
    description: 'LLM-based code review that emits a quality score (0.0–1.0) and findings list across dimensions: correctness, security, performance, maintainability, test coverage. Like CodeRabbit but with Studio traceability.',
    requiresAutomationGate: false,
    category: 'quality',
    profile: 'analyzer',
...
export const FLOW_DEFS: FlowDef[] = [
  ...
  // ── Refinement flows (score-gate iteration) ───────────────────────────────
  {
...
export const FLOW_GRAPH_DEFS: FlowGraphDef[] = [
  ...
  // ─── Flow 4: PRD Creation ─────────────────────────────────────────────────
  {
    id: 'flow-prd-creation',
    name: 'Create PRD',
    description: 'Draft a PRD, validate completeness and traceability, then get stakeholder approval',
    category: 'sdlc',
    nodes: [
      { id: 'p-start',         nodeType: 'start',      label: 'Start',                                      position: { x: 40,  y: 200 } },
      { id: 'p-drafter',       nodeType: 'worker',     label: 'PRD Drafter',     sublabel: 'LLM · quality', position: { x: 220, y: 200 } },
      { id: 'p-gate-complete', nodeType: 'gate',       label: 'Completeness?',   maxRetries: 2,             position: { x: 440, y: 200 } },
      { id: 'p-gate-trace',    nodeType: 'gate',       label: 'Traceability?',   maxRetries: 2,             position: { x: 660, y: 200 } },
      { id: 'p-approval',      nodeType: 'human',      label: 'Stakeholder Approval',                       position: { x: 880, y: 200 } },
      { id: 'p-end',           nodeType: 'end',        label: 'Done',                                       position: { x: 1100, y: 200 } },
      { id: 'p-esc',           nodeType: 'escalation', label: 'Escalate',                                   position: { x: 440, y: 350 } },
    ],
    edges: [
      { id: 'p1', source: 'p-start',         target: 'p-drafter',       edgeKind: 'default' },
      { id: 'p2', source: 'p-drafter',       target: 'p-gate-complete', edgeKind: 'default' },
      { id: 'p3', source: 'p-gate-complete', target: 'p-gate-trace',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'p4', source: 'p-gate-complete', target: 'p-drafter',       edgeKind: 'fail',  label: 'retry' },
      { id: 'p5', source: 'p-gate-complete', target: 'p-esc',           edgeKind: 'fail',  label: 'Escalate' },
      { id: 'p6', source: 'p-gate-trace',    target: 'p-approval',      edgeKind: 'pass',  label: 'PASS' },
      { id: 'p7', source: 'p-gate-trace',    target: 'p-drafter',       edgeKind: 'fail',  label: 'retry' },
      { id: 'p8', source: 'p-approval',      target: 'p-end',           edgeKind: 'pass',  label: 'Approved' },
      { id: 'p9', source: 'p-approval',      target: 'p-drafter',       edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 5: Design Creation ──────────────────────────────────────────────
  {
    id: 'flow-design-creation',
    name: 'Create System Design',
    description: 'Author a system design, run gap analysis and PRD traceability, then get architecture review',
    category: 'sdlc',
    nodes: [
      { id: 'dc-start',      nodeType: 'start',      label: 'Start',                                        position: { x: 40,  y: 200 } },
      { id: 'dc-author',     nodeType: 'worker',     label: 'Design Author',    sublabel: 'LLM · quality',  position: { x: 220, y: 200 } },
      { id: 'dc-gate-gap',   nodeType: 'gate',       label: 'Gap Analysis?',    maxRetries: 2,              position: { x: 440, y: 200 } },
      { id: 'dc-gate-trace', nodeType: 'gate',       label: 'PRD Traceability?',maxRetries: 2,              position: { x: 660, y: 200 } },
      { id: 'dc-approval',   nodeType: 'human',      label: 'Architecture Review',                          position: { x: 880, y: 200 } },
      { id: 'dc-end',        nodeType: 'end',        label: 'Done',                                         position: { x: 1100, y: 200 } },
      { id: 'dc-esc',        nodeType: 'escalation', label: 'Escalate',                                     position: { x: 440, y: 350 } },
    ],
    edges: [
      { id: 'dc1', source: 'dc-start',      target: 'dc-author',     edgeKind: 'default' },
      { id: 'dc2', source: 'dc-author',     target: 'dc-gate-gap',   edgeKind: 'default' },
      { id: 'dc3', source: 'dc-gate-gap',   target: 'dc-gate-trace', edgeKind: 'pass',  label: 'PASS' },
      { id: 'dc4', source: 'dc-gate-gap',   target: 'dc-author',     edgeKind: 'fail',  label: 'retry' },
      { id: 'dc5', source: 'dc-gate-gap',   target: 'dc-esc',        edgeKind: 'fail',  label: 'Escalate' },
      { id: 'dc6', source: 'dc-gate-trace', target: 'dc-approval',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'dc7', source: 'dc-gate-trace', target: 'dc-author',     edgeKind: 'fail',  label: 'retry' },
      { id: 'dc8', source: 'dc-approval',   target: 'dc-end',        edgeKind: 'pass',  label: 'Approved' },
      { id: 'dc9', source: 'dc-approval',   target: 'dc-author',     edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 6: ADR Creation ─────────────────────────────────────────────────
  {
    id: 'flow-adr-creation',
    name: 'Record Architecture Decision',
    description: 'Draft an ADR, validate completeness, then peer review',
    category: 'sdlc',
    nodes: [
      { id: 'ac-start',     nodeType: 'start',      label: 'Start',                                         position: { x: 40,  y: 200 } },
      { id: 'ac-drafter',   nodeType: 'worker',     label: 'ADR Drafter',      sublabel: 'LLM · quality',   position: { x: 260, y: 200 } },
      { id: 'ac-gate-comp', nodeType: 'gate',       label: 'Completeness?',    maxRetries: 2,               position: { x: 500, y: 200 } },
      { id: 'ac-review',    nodeType: 'human',      label: 'Peer Review',                                   position: { x: 740, y: 200 } },
      { id: 'ac-end',       nodeType: 'end',        label: 'Done',                                          position: { x: 960, y: 200 } },
      { id: 'ac-esc',       nodeType: 'escalation', label: 'Escalate',                                      position: { x: 500, y: 350 } },
    ],
    edges: [
      { id: 'ac1', source: 'ac-start',     target: 'ac-drafter',  edgeKind: 'default' },
      { id: 'ac2', source: 'ac-drafter',   target: 'ac-gate-comp',edgeKind: 'default' },
      { id: 'ac3', source: 'ac-gate-comp', target: 'ac-review',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'ac4', source: 'ac-gate-comp', target: 'ac-drafter',  edgeKind: 'fail',  label: 'retry' },
      { id: 'ac5', source: 'ac-gate-comp', target: 'ac-esc',      edgeKind: 'fail',  label: 'Escalate' },
      { id: 'ac6', source: 'ac-review',    target: 'ac-end',      edgeKind: 'pass',  label: 'Approved' },
      { id: 'ac7', source: 'ac-review',    target: 'ac-drafter',  edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 7: Feature Spec ─────────────────────────────────────────────────
  {
    id: 'flow-feature-spec',
    name: 'Author Feature Spec',
    description: 'Author a feature spec, validate design alignment and test scenarios, then approve',
    category: 'sdlc',
    nodes: [
      { id: 'fs-start',       nodeType: 'start',      label: 'Start',                                       position: { x: 40,  y: 200 } },
      { id: 'fs-author',      nodeType: 'worker',     label: 'Spec Author',      sublabel: 'LLM · quality', position: { x: 220, y: 200 } },
      { id: 'fs-gate-design', nodeType: 'gate',       label: 'Design Valid?',    maxRetries: 2,             position: { x: 440, y: 200 } },
      { id: 'fs-gate-tests',  nodeType: 'gate',       label: 'Test Scenarios?',  maxRetries: 2,             position: { x: 660, y: 200 } },
      { id: 'fs-approval',    nodeType: 'human',      label: 'Approve Spec',                                position: { x: 880, y: 200 } },
      { id: 'fs-end',         nodeType: 'end',        label: 'Done',                                        position: { x: 1100, y: 200 } },
      { id: 'fs-esc',         nodeType: 'escalation', label: 'Escalate',                                    position: { x: 440, y: 350 } },
    ],
    edges: [
      { id: 'fs1', source: 'fs-start',       target: 'fs-author',      edgeKind: 'default' },
      { id: 'fs2', source: 'fs-author',      target: 'fs-gate-design', edgeKind: 'default' },
      { id: 'fs3', source: 'fs-gate-design', target: 'fs-gate-tests',  edgeKind: 'pass',  label: 'PASS' },
      { id: 'fs4', source: 'fs-gate-design', target: 'fs-author',      edgeKind: 'fail',  label: 'retry' },
      { id: 'fs5', source: 'fs-gate-design', target: 'fs-esc',         edgeKind: 'fail',  label: 'Escalate' },
      { id: 'fs6', source: 'fs-gate-tests',  target: 'fs-approval',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'fs7', source: 'fs-gate-tests',  target: 'fs-author',      edgeKind: 'fail',  label: 'retry' },
      { id: 'fs8', source: 'fs-approval',    target: 'fs-end',         edgeKind: 'pass',  label: 'Approved' },
      { id: 'fs9', source: 'fs-approval',    target: 'fs-author',      edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 8: Implement & Review ───────────────────────────────────────────
  {
    id: 'flow-implement-review',
    name: 'Implement & Review',
    description: 'Decompose tasks, implement, confirm tests pass, create PR, validate design',
    category: 'sdlc',
    nodes: [
      { id: 'ir-start',       nodeType: 'start',      label: 'Start',                                       position: { x: 40,  y: 200 } },
      { id: 'ir-decomp',      nodeType: 'worker',     label: 'Decompose',        sublabel: 'LLM · quality', position: { x: 220, y: 200 } },
      { id: 'ir-impl',        nodeType: 'worker',     label: 'Implement',        sublabel: 'LLM · coding',  position: { x: 440, y: 200 } },
      { id: 'ir-gate-tests',  nodeType: 'gate',       label: 'Tests Pass?',      maxRetries: 3,             position: { x: 660, y: 200 } },
      { id: 'ir-pr',          nodeType: 'worker',     label: 'Create PR',        sublabel: 'hybrid · platform', position: { x: 880, y: 200 } },
      { id: 'ir-gate-design', nodeType: 'gate',       label: 'Design Valid?',    maxRetries: 2,             position: { x: 1100, y: 200 } },
      { id: 'ir-end',         nodeType: 'end',        label: 'Done',                                        position: { x: 1320, y: 200 } },
      { id: 'ir-esc',         nodeType: 'escalation', label: 'Escalate',                                    position: { x: 1100, y: 350 } },
    ],
    edges: [
      { id: 'ir1', source: 'ir-start',       target: 'ir-decomp',      edgeKind: 'default' },
      { id: 'ir2', source: 'ir-decomp',      target: 'ir-impl',        edgeKind: 'default' },
      { id: 'ir3', source: 'ir-impl',        target: 'ir-gate-tests',  edgeKind: 'default' },
      { id: 'ir4', source: 'ir-gate-tests',  target: 'ir-pr',          edgeKind: 'pass',  label: 'PASS' },
      { id: 'ir5', source: 'ir-gate-tests',  target: 'ir-impl',        edgeKind: 'fail',  label: 'retry' },
      { id: 'ir6', source: 'ir-pr',          target: 'ir-gate-design', edgeKind: 'default' },
      { id: 'ir7', source: 'ir-gate-design', target: 'ir-end',         edgeKind: 'pass',  label: 'PASS' },
      { id: 'ir8', source: 'ir-gate-design', target: 'ir-impl',        edgeKind: 'fail',  label: 'retry' },
      { id: 'ir9', source: 'ir-gate-design', target: 'ir-esc',         edgeKind: 'fail',  label: 'Escalate' },
    ],
  },
  ...
  // ─── Flow 9: TDD ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Write failing tests, confirm they fail, implement to pass, confirm pass, create PR',
    category: 'sdlc',
    nodes: [
      { id: 'td-start',      nodeType: 'start',      label: 'Start',                                        position: { x: 40,  y: 200 } },
      { id: 'td-tests',      nodeType: 'worker',     label: 'Write Tests',      sublabel: 'LLM · quality',  position: { x: 220, y: 200 } },
      { id: 'td-gate-fail',  nodeType: 'gate',       label: 'Tests Fail?',      maxRetries: 2,              position: { x: 440, y: 200 } },
      { id: 'td-impl',       nodeType: 'worker',     label: 'Implement',        sublabel: 'LLM · coding',   position: { x: 660, y: 200 } },
      { id: 'td-gate-pass',  nodeType: 'gate',       label: 'Tests Pass?',      maxRetries: 3,              position: { x: 880, y: 200 } },
      { id: 'td-pr',         nodeType: 'worker',     label: 'Create PR',        sublabel: 'hybrid · platform', position: { x: 1100, y: 200 } },
      { id: 'td-end',        nodeType: 'end',        label: 'Done',                                         position: { x: 1320, y: 200 } },
      { id: 'td-esc',        nodeType: 'escalation', label: 'Escalate',                                     position: { x: 880, y: 350 } },
    ],
    edges: [
      { id: 'td1', source: 'td-start',     target: 'td-tests',     edgeKind: 'default' },
      { id: 'td2', source: 'td-tests',     target: 'td-gate-fail', edgeKind: 'default' },
      { id: 'td3', source: 'td-gate-fail', target: 'td-impl',      edgeKind: 'pass',  label: 'Confirmed' },
      { id: 'td4', source: 'td-gate-fail', target: 'td-tests',     edgeKind: 'fail',  label: 'retry' },
      { id: 'td5', source: 'td-impl',      target: 'td-gate-pass', edgeKind: 'default' },
      { id: 'td6', source: 'td-gate-pass', target: 'td-pr',        edgeKind: 'pass',  label: 'PASS' },
      { id: 'td7', source: 'td-gate-pass', target: 'td-impl',      edgeKind: 'fail',  label: 'retry' },
      { id: 'td8', source: 'td-gate-pass', target: 'td-esc',       edgeKind: 'fail',  label: 'Escalate' },
      { id: 'td9', source: 'td-pr',        target: 'td-end',       edgeKind: 'default' },
    ],
  },

  // ─── Flow 10: Decompose & Plan Sprint ─────────────────────────────────────
  {
    id: 'flow-decompose-plan',
    name: 'Decompose & Plan Sprint',
    description: 'Decompose a design into tasks, trace coverage, check completeness, get sprint approval',
    category: 'sdlc',
    nodes: [
      { id: 'dp-start',      nodeType: 'start',      label: 'Start',                                        position: { x: 40,  y: 200 } },
      { id: 'dp-decomp',     nodeType: 'worker',     label: 'Decompose',        sublabel: 'LLM · quality',  position: { x: 220, y: 200 } },
      { id: 'dp-gate-trace', nodeType: 'gate',       label: 'Traceability?',    maxRetries: 2,              position: { x: 440, y: 200 } },
      { id: 'dp-gate-comp',  nodeType: 'gate',       label: 'Completeness?',    maxRetries: 2,              position: { x: 660, y: 200 } },
      { id: 'dp-approval',   nodeType: 'human',      label: 'Sprint Approval',                              position: { x: 880, y: 200 } },
      { id: 'dp-end',        nodeType: 'end',        label: 'Done',                                         position: { x: 1100, y: 200 } },
      { id: 'dp-esc',        nodeType: 'escalation', label: 'Escalate',                                     position: { x: 440, y: 350 } },
    ],
    edges: [
      { id: 'dp1', source: 'dp-start',      target: 'dp-decomp',     edgeKind: 'default' },
      { id: 'dp2', source: 'dp-decomp',     target: 'dp-gate-trace', edgeKind: 'default' },
      { id: 'dp3', source: 'dp-gate-trace', target: 'dp-gate-comp',  edgeKind: 'pass',  label: 'PASS' },
      { id: 'dp4', source: 'dp-gate-trace', target: 'dp-decomp',     edgeKind: 'fail',  label: 'retry' },
      { id: 'dp5', source: 'dp-gate-trace', target: 'dp-esc',        edgeKind: 'fail',  label: 'Escalate' },
      { id: 'dp6', source: 'dp-gate-comp',  target: 'dp-approval',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'dp7', source: 'dp-gate-comp',  target: 'dp-decomp',     edgeKind: 'fail',  label: 'retry' },
      { id: 'dp8', source: 'dp-approval',   target: 'dp-end',        edgeKind: 'pass',  label: 'Approved' },
      { id: 'dp9', source: 'dp-approval',   target: 'dp-decomp',     edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 11: Code Review Pipeline ───────────────────────────────────────
  {
    id: 'flow-code-review',
    name: 'Code Review Pipeline',
    description: 'Design conformance → security scan → test coverage → traceability → final approval',
    category: 'sdlc',
    nodes: [
      { id: 'cr-start',       nodeType: 'start',      label: 'PR Ready',                                    position: { x: 40,  y: 200 } },
      { id: 'cr-gate-design',        nodeType: 'gate',       label: 'Design Conform?',  maxRetries: 2,             position: { x: 220, y: 200 } },
      { id: 'cr-security-analyzer',  nodeType: 'gate',       label: 'Security Impact?', maxRetries: 1,             position: { x: 440, y: 200 } },
      { id: 'cr-gate-cov',           nodeType: 'gate',       label: 'Test Coverage?',   maxRetries: 2,             position: { x: 660, y: 200 } },
      { id: 'cr-traceability-analyzer', nodeType: 'gate',    label: 'Traceability?',    maxRetries: 2,             position: { x: 880, y: 200 } },
      { id: 'cr-approval',    nodeType: 'human',      label: 'Final Approval',                              position: { x: 1100, y: 200 } },
      { id: 'cr-end',         nodeType: 'end',        label: 'Merged',                                      position: { x: 1320, y: 200 } },
      { id: 'cr-esc',         nodeType: 'escalation', label: 'Security Block',                              position: { x: 440, y: 350 } },
    ],
    edges: [
      { id: 'cr1',  source: 'cr-start',              target: 'cr-gate-design',           edgeKind: 'default' },
      { id: 'cr2',  source: 'cr-gate-design',         target: 'cr-security-analyzer',      edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr3',  source: 'cr-gate-design',         target: 'cr-gate-design',            edgeKind: 'fail',  label: 'retry' },
      { id: 'cr4',  source: 'cr-security-analyzer',   target: 'cr-gate-cov',               edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr5',  source: 'cr-security-analyzer',   target: 'cr-esc',                    edgeKind: 'fail',  label: 'Block' },
      { id: 'cr6',  source: 'cr-gate-cov',            target: 'cr-traceability-analyzer',  edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr7',  source: 'cr-gate-cov',            target: 'cr-gate-cov',               edgeKind: 'fail',  label: 'retry' },
      { id: 'cr8',  source: 'cr-traceability-analyzer', target: 'cr-approval',             edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr9',  source: 'cr-traceability-analyzer', target: 'cr-traceability-analyzer',edgeKind: 'fail',  label: 'retry' },
      { id: 'cr10', source: 'cr-approval',            target: 'cr-end',                    edgeKind: 'pass',  label: 'Approved' },
      { id: 'cr11', source: 'cr-approval',            target: 'cr-gate-design',            edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 12: Design Peer Review ─────────────────────────────────────────
  {
    id: 'flow-design-review',
    name: 'Design Peer Review',
    description: 'Gap analysis → PRD traceability → security review → architecture approval',
    category: 'sdlc',
    nodes: [
      { id: 'dr-start',      nodeType: 'start',      label: 'Design Ready',                                 position: { x: 40,  y: 200 } },
      { id: 'dr-gate-gap',        nodeType: 'gate',       label: 'Gap Analysis?',    maxRetries: 2,              position: { x: 220, y: 200 } },
      { id: 'dr-gate-trace',      nodeType: 'gate',       label: 'PRD Traceability?',maxRetries: 2,              position: { x: 440, y: 200 } },
      { id: 'dr-security-analyzer', nodeType: 'gate',     label: 'Security Review?', maxRetries: 1,              position: { x: 660, y: 200 } },
      { id: 'dr-approval',   nodeType: 'human',      label: 'Architecture Approval',                        position: { x: 880, y: 200 } },
      { id: 'dr-end',        nodeType: 'end',        label: 'Done',                                         position: { x: 1100, y: 200 } },
      { id: 'dr-esc',        nodeType: 'escalation', label: 'Security Block',                               position: { x: 660, y: 350 } },
    ],
    edges: [
      { id: 'dr1', source: 'dr-start',      target: 'dr-gate-gap',   edgeKind: 'default' },
      { id: 'dr2', source: 'dr-gate-gap',   target: 'dr-gate-trace', edgeKind: 'pass',  label: 'PASS' },
      { id: 'dr3', source: 'dr-gate-gap',   target: 'dr-gate-gap',   edgeKind: 'fail',  label: 'retry' },
      { id: 'dr4', source: 'dr-gate-trace',        target: 'dr-security-analyzer', edgeKind: 'pass',  label: 'PASS' },
      { id: 'dr5', source: 'dr-gate-trace',        target: 'dr-gate-trace',        edgeKind: 'fail',  label: 'retry' },
      { id: 'dr6', source: 'dr-security-analyzer', target: 'dr-approval',          edgeKind: 'pass',  label: 'PASS' },
      { id: 'dr7', source: 'dr-security-analyzer', target: 'dr-esc',               edgeKind: 'fail',  label: 'Block' },
      { id: 'dr8', source: 'dr-approval',   target: 'dr-end',        edgeKind: 'pass',  label: 'Approved' },
      { id: 'dr9', source: 'dr-approval',   target: 'dr-gate-gap',   edgeKind: 'fail',  label: 'Changes' },
    ],
  },

  // ─── Flow 13: Security Audit ──────────────────────────────────────────────
  {
    id: 'flow-security-audit',
    name: 'Security Audit',
    description: 'Security impact → control gaps → fix remediations → verify → security sign-off',
    category: 'sdlc',
    nodes: [
      { id: 'sa-start',       nodeType: 'start',      label: 'Start',                                       position: { x: 40,  y: 200 } },
      { id: 'sa-security-analyzer', nodeType: 'gate',   label: 'Security Impact?', maxRetries: 1,             position: { x: 220, y: 200 } },
      { id: 'sa-gate-gaps',         nodeType: 'gate',   label: 'Control Gaps?',    maxRetries: 2,             position: { x: 440, y: 200 } },
      { id: 'sa-fix',               nodeType: 'worker', label: 'Fix Worker',       sublabel: 'LLM · security',position: { x: 660, y: 200 } },
      { id: 'sa-verify-analyzer',   nodeType: 'gate',   label: 'Verify Remed.?',   maxRetries: 2,             position: { x: 880, y: 200 } },
      { id: 'sa-approval',    nodeType: 'human',      label: 'Security Sign-off',                           position: { x: 1100, y: 200 } },
      { id: 'sa-end',         nodeType: 'end',        label: 'Done',                                        position: { x: 1320, y: 200 } },
      { id: 'sa-esc',         nodeType: 'escalation', label: 'Critical Block',                              position: { x: 220, y: 350 } },
    ],
    edges: [
      { id: 'sa1',  source: 'sa-start',            target: 'sa-security-analyzer', edgeKind: 'default' },
      { id: 'sa2',  source: 'sa-security-analyzer', target: 'sa-gate-gaps',         edgeKind: 'pass',  label: 'PASS' },
      { id: 'sa3',  source: 'sa-security-analyzer', target: 'sa-esc',               edgeKind: 'fail',  label: 'Critical' },
      { id: 'sa4',  source: 'sa-gate-gaps',        target: 'sa-fix',                edgeKind: 'pass',  label: 'Gaps found' },
      { id: 'sa5',  source: 'sa-gate-gaps',        target: 'sa-gate-gaps',          edgeKind: 'fail',  label: 'retry' },
      { id: 'sa6',  source: 'sa-fix',              target: 'sa-verify-analyzer',    edgeKind: 'default' },
      { id: 'sa7',  source: 'sa-verify-analyzer',  target: 'sa-approval',           edgeKind: 'pass',  label: 'PASS' },
      { id: 'sa8',  source: 'sa-verify-analyzer',  target: 'sa-fix',                edgeKind: 'fail',  label: 'retry' },
      { id: 'sa9',  source: 'sa-approval',    target: 'sa-end',         edgeKind: 'pass',  label: 'Signed off' },
      { id: 'sa10', source: 'sa-approval',    target: 'sa-fix',         edgeKind: 'fail',  label: 'More fixes' },
    ],
  },

  // ─── Flow 14: Incident → Postmortem ──────────────────────────────────────
  {
    id: 'flow-incident-postmortem',
    name: 'Incident → Postmortem',
    description: 'Validate incident → find root component → implement fix → verify → PR → postmortem sign-off',
    category: 'ops',
    nodes: [
      { id: 'ip-start',       nodeType: 'start',      label: 'Incident',                                    position: { x: 40,  y: 200 } },
      { id: 'ip-gate-valid',  nodeType: 'gate',       label: 'Valid Incident?',  maxRetries: 1,             position: { x: 220, y: 200 } },
      { id: 'ip-find',        nodeType: 'worker',     label: 'Find Root Comp.',  sublabel: 'script · ops',  position: { x: 440, y: 200 } },
      { id: 'ip-fix',         nodeType: 'worker',     label: 'Implement Fix',    sublabel: 'LLM · coding',  position: { x: 660, y: 200 } },
      { id: 'ip-gate-verify', nodeType: 'gate',       label: 'Verify Fix?',      maxRetries: 3,             position: { x: 880, y: 200 } },
      { id: 'ip-pr',          nodeType: 'worker',     label: 'Create PR',        sublabel: 'hybrid · platform', position: { x: 1100, y: 200 } },
      { id: 'ip-approval',    nodeType: 'human',      label: 'Postmortem Sign-off',                         position: { x: 1320, y: 200 } },
      { id: 'ip-end',         nodeType: 'end',        label: 'Resolved',                                    position: { x: 1540, y: 200 } },
      { id: 'ip-closed',      nodeType: 'escalation', label: 'Closed (invalid)',                            position: { x: 220, y: 350 } },
    ],
    edges: [
      { id: 'ip1',  source: 'ip-start',       target: 'ip-gate-valid',  edgeKind: 'default' },
      { id: 'ip2',  source: 'ip-gate-valid',  target: 'ip-find',        edgeKind: 'pass',  label: 'Valid' },
      { id: 'ip3',  source: 'ip-gate-valid',  target: 'ip-closed',      edgeKind: 'fail',  label: 'Invalid' },
      { id: 'ip4',  source: 'ip-find',        target: 'ip-fix',         edgeKind: 'default' },
      { id: 'ip5',  source: 'ip-fix',         target: 'ip-gate-verify', edgeKind: 'default' },
      { id: 'ip6',  source: 'ip-gate-verify', target: 'ip-pr',          edgeKind: 'pass',  label: 'PASS' },
      { id: 'ip7',  source: 'ip-gate-verify', target: 'ip-fix',         edgeKind: 'fail',  label: 'retry' },
      { id: 'ip8',  source: 'ip-pr',          target: 'ip-approval',    edgeKind: 'default' },
      { id: 'ip9',  source: 'ip-approval',    target: 'ip-end',         edgeKind: 'pass',  label: 'Signed off' },
      { id: 'ip10', source: 'ip-approval',    target: 'ip-fix',         edgeKind: 'fail',  label: 'More work' },
    ],
  },

  // ─── Flow 15: Emergency Hotfix ────────────────────────────────────────────
  {
    id: 'flow-hotfix',
    name: 'Emergency Hotfix',
    description: 'Validate bug → hotfix implement → confirm tests pass → PR → expedited review → deploy',
    category: 'ops',
    nodes: [
      { id: 'hf-start',       nodeType: 'start',      label: 'Incident',                                    position: { x: 40,  y: 200 } },
      { id: 'hf-gate-valid',  nodeType: 'gate',       label: 'Validate Bug?',    maxRetries: 1,             position: { x: 220, y: 200 } },
      { id: 'hf-impl',        nodeType: 'worker',     label: 'Hotfix Implement', sublabel: 'LLM · coding',  position: { x: 440, y: 200 } },
      { id: 'hf-gate-tests',  nodeType: 'gate',       label: 'Tests Pass?',      maxRetries: 3,             position: { x: 660, y: 200 } },
      { id: 'hf-pr',          nodeType: 'worker',     label: 'Create PR',        sublabel: 'hybrid · platform', position: { x: 880, y: 200 } },
      { id: 'hf-gate-review', nodeType: 'gate',       label: 'Expedited Review?',maxRetries: 1,             position: { x: 1100, y: 200 } },
      { id: 'hf-deploy',      nodeType: 'worker',     label: 'Deploy to Prod',   sublabel: 'script · ops',  position: { x: 1320, y: 200 } },
      { id: 'hf-end',         nodeType: 'end',        label: 'Deployed',                                    position: { x: 1540, y: 200 } },
      { id: 'hf-closed',      nodeType: 'escalation', label: 'Closed (invalid)',                            position: { x: 220, y: 350 } },
      { id: 'hf-esc',         nodeType: 'escalation', label: 'Escalate Review',                             position: { x: 1100, y: 350 } },
    ],
    edges: [
      { id: 'hf1',  source: 'hf-start',       target: 'hf-gate-valid',  edgeKind: 'default' },
      { id: 'hf2',  source: 'hf-gate-valid',  target: 'hf-impl',        edgeKind: 'pass',  label: 'Valid' },
      { id: 'hf3',  source: 'hf-gate-valid',  target: 'hf-closed',      edgeKind: 'fail',  label: 'Invalid' },
      { id: 'hf4',  source: 'hf-impl',        target: 'hf-gate-tests',  edgeKind: 'default' },
      { id: 'hf5',  source: 'hf-gate-tests',  target: 'hf-pr',          edgeKind: 'pass',  label: 'PASS' },
      { id: 'hf6',  source: 'hf-gate-tests',  target: 'hf-impl',        edgeKind: 'fail',  label: 'retry' },
      { id: 'hf7',  source: 'hf-pr',          target: 'hf-gate-review', edgeKind: 'default' },
      { id: 'hf8',  source: 'hf-gate-review', target: 'hf-deploy',      edgeKind: 'pass',  label: 'Approved' },
      { id: 'hf9',  source: 'hf-gate-review', target: 'hf-esc',         edgeKind: 'fail',  label: 'Escalate' },
      { id: 'hf10', source: 'hf-deploy',      target: 'hf-end',         edgeKind: 'default' },
    ],
  },

  // ─── Flow 16: Create Release Candidate ───────────────────────────────────
  {
    id: 'flow-release-candidate',
    name: 'Create Release Candidate',
    description: 'Final gap analysis → test coverage gate → security scan → package release',
    category: 'ops',
    nodes: [
      { id: 'rc-start',     nodeType: 'start',      label: 'Build Ready',                                   position: { x: 40,  y: 200 } },
      { id: 'rc-gate-gap',  nodeType: 'gate',       label: 'Final Gap Analysis?',maxRetries: 2,             position: { x: 260, y: 200 } },
      { id: 'rc-gate-cov',  nodeType: 'gate',       label: 'Test Coverage?',   maxRetries: 2,               position: { x: 500, y: 200 } },
      { id: 'rc-gate-sec',  nodeType: 'gate',       label: 'Security Scan?',   maxRetries: 1,               position: { x: 740, y: 200 } },
      { id: 'rc-package',   nodeType: 'worker',     label: 'Package Release',  sublabel: 'script · ops',    position: { x: 980, y: 200 } },
      { id: 'rc-end',       nodeType: 'end',        label: 'RC Ready',                                      position: { x: 1200, y: 200 } },
      { id: 'rc-esc',       nodeType: 'escalation', label: 'Security Block',                                position: { x: 740, y: 350 } },
    ],
    edges: [
      { id: 'rc1', source: 'rc-start',     target: 'rc-gate-gap', edgeKind: 'default' },
      { id: 'rc2', source: 'rc-gate-gap',  target: 'rc-gate-cov', edgeKind: 'pass',  label: 'PASS' },
      { id: 'rc3', source: 'rc-gate-gap',  target: 'rc-gate-gap', edgeKind: 'fail',  label: 'retry' },
      { id: 'rc4', source: 'rc-gate-cov',  target: 'rc-gate-sec', edgeKind: 'pass',  label: 'PASS' },
      { id: 'rc5', source: 'rc-gate-cov',  target: 'rc-gate-cov', edgeKind: 'fail',  label: 'retry' },
      { id: 'rc6', source: 'rc-gate-sec',  target: 'rc-package',  edgeKind: 'pass',  label: 'PASS' },
      { id: 'rc7', source: 'rc-gate-sec',  target: 'rc-esc',      edgeKind: 'fail',  label: 'Block' },
      { id: 'rc8', source: 'rc-package',   target: 'rc-end',      edgeKind: 'default' },
    ],
  },

  // ─── Flow 17: Staged Deployment ───────────────────────────────────────────
  {
    id: 'flow-staged-deployment',
    name: 'Staged Deployment',
    description: 'Deploy to staging → smoke tests → security verify → production approval → deploy to prod',
    category: 'ops',
    nodes: [
      { id: 'sd-start',      nodeType: 'start',      label: 'Release Ready',                                position: { x: 40,  y: 200 } },
      { id: 'sd-staging',    nodeType: 'worker',     label: 'Deploy to Staging',sublabel: 'script · ops',   position: { x: 220, y: 200 } },
      { id: 'sd-gate-smoke', nodeType: 'gate',       label: 'Smoke Tests?',     maxRetries: 2,              position: { x: 440, y: 200 } },
      { id: 'sd-gate-sec',   nodeType: 'gate',       label: 'Security Verify?', maxRetries: 1,              position: { x: 660, y: 200 } },
      { id: 'sd-approval',   nodeType: 'human',      label: 'Production Approval',                          position: { x: 880, y: 200 } },
      { id: 'sd-prod',       nodeType: 'worker',     label: 'Deploy to Prod',   sublabel: 'script · ops',   position: { x: 1100, y: 200 } },
      { id: 'sd-end',        nodeType: 'end',        label: 'Live',                                         position: { x: 1320, y: 200 } },
      { id: 'sd-esc',        nodeType: 'escalation', label: 'Security Block',                               position: { x: 660, y: 350 } },
    ],
    edges: [
      { id: 'sd1', source: 'sd-start',      target: 'sd-staging',    edgeKind: 'default' },
      { id: 'sd2', source: 'sd-staging',    target: 'sd-gate-smoke', edgeKind: 'default' },
      { id: 'sd3', source: 'sd-gate-smoke', target: 'sd-gate-sec',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'sd4', source: 'sd-gate-smoke', target: 'sd-staging',    edgeKind: 'fail',  label: 'retry' },
      { id: 'sd5', source: 'sd-gate-sec',   target: 'sd-approval',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'sd6', source: 'sd-gate-sec',   target: 'sd-esc',        edgeKind: 'fail',  label: 'Block' },
      { id: 'sd7', source: 'sd-approval',   target: 'sd-prod',       edgeKind: 'pass',  label: 'Approved' },
      { id: 'sd8', source: 'sd-approval',   target: 'sd-staging',    edgeKind: 'fail',  label: 'Reject' },
      { id: 'sd9', source: 'sd-prod',       target: 'sd-end',        edgeKind: 'default' },
    ],
  },

  // ─── Flow 18: Regression Testing ─────────────────────────────────────────
  {
    id: 'flow-regression-test',
    name: 'Regression Testing',
    description: 'Identify test scope → run coverage → triage failures → QA sign-off',
    category: 'ops',
    nodes: [
      { id: 'rt-start',       nodeType: 'start',      label: 'Start',                                       position: { x: 40,  y: 200 } },
      { id: 'rt-gate-scope',  nodeType: 'gate',       label: 'Identify Scope?',  maxRetries: 1,             position: { x: 260, y: 200 } },
      { id: 'rt-gate-cov',    nodeType: 'gate',       label: 'Run Coverage?',    maxRetries: 2,             position: { x: 500, y: 200 } },
      { id: 'rt-gate-triage', nodeType: 'gate',       label: 'Triage Failures?', maxRetries: 2,             position: { x: 740, y: 200 } },
      { id: 'rt-approval',    nodeType: 'human',      label: 'QA Sign-off',                                 position: { x: 980, y: 200 } },
      { id: 'rt-end',         nodeType: 'end',        label: 'Done',                                        position: { x: 1200, y: 200 } },
      { id: 'rt-esc',         nodeType: 'escalation', label: 'Escalate Failures',                           position: { x: 740, y: 350 } },
    ],
    edges: [
      { id: 'rt1', source: 'rt-start',       target: 'rt-gate-scope',  edgeKind: 'default' },
      { id: 'rt2', source: 'rt-gate-scope',  target: 'rt-gate-cov',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'rt3', source: 'rt-gate-scope',  target: 'rt-gate-scope', edgeKind: 'fail',  label: 'retry' },
      { id: 'rt4', source: 'rt-gate-cov',    target: 'rt-gate-triage',edgeKind: 'pass',  label: 'PASS' },
      { id: 'rt5', source: 'rt-gate-cov',    target: 'rt-gate-cov',   edgeKind: 'fail',  label: 'retry' },
      { id: 'rt6', source: 'rt-gate-triage', target: 'rt-approval',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'rt7', source: 'rt-gate-triage', target: 'rt-esc',        edgeKind: 'fail',  label: 'Escalate' },
      { id: 'rt8', source: 'rt-approval',    target: 'rt-end',        edgeKind: 'pass',  label: 'Signed off' },
