...
export const FLOW_GRAPH_DEFS: FlowGraphDef[] = [
  ...
  // ─── Flow 11: Code Review Pipeline ───────────────────────────────────────
  {
    ...
    nodes: [
      ...
      { id: 'cr-gate-sec',    nodeType: 'gate',       label: 'Security Impact?', maxRetries: 1,             position: { x: 440, y: 200 } },
      { id: 'cr-gate-cov',    nodeType: 'gate',       label: 'Test Coverage?',   maxRetries: 2,             position: { x: 660, y: 200 } },
      { id: 'cr-gate-trace',  nodeType: 'gate',       label: 'Traceability?',    maxRetries: 2,             position: { x: 880, y: 200 } },
    ...
    edges: [
      ...
      { id: 'cr2',  source: 'cr-gate-design', target: 'cr-gate-sec',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr3',  source: 'cr-gate-design', target: 'cr-gate-design', edgeKind: 'fail',  label: 'retry' },
      { id: 'cr4',  source: 'cr-gate-sec',    target: 'cr-gate-cov',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr5',  source: 'cr-gate-sec',    target: 'cr-esc',         edgeKind: 'fail',  label: 'Block' },
      { id: 'cr6',  source: 'cr-gate-cov',    target: 'cr-gate-trace',  edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr7',  source: 'cr-gate-cov',    target: 'cr-gate-cov',    edgeKind: 'fail',  label: 'retry' },
      { id: 'cr8',  source: 'cr-gate-trace',  target: 'cr-approval',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'cr9',  source: 'cr-gate-trace',  target: 'cr-gate-trace',  edgeKind: 'fail',  label: 'retry' },
  ...
  // ─── Flow 12: Design Peer Review ─────────────────────────────────────────
  {
    ...
    nodes: [
      ...
      { id: 'dr-gate-sec',   nodeType: 'gate',       label: 'Security Review?', maxRetries: 1,              position: { x: 660, y: 200 } },
    ...
    edges: [
      ...
      { id: 'dr4', source: 'dr-gate-trace', target: 'dr-gate-sec',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'dr5', source: 'dr-gate-trace', target: 'dr-gate-trace', edgeKind: 'fail',  label: 'retry' },
      { id: 'dr6', source: 'dr-gate-sec',   target: 'dr-approval',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'dr7', source: 'dr-gate-sec',   target: 'dr-esc',        edgeKind: 'fail',  label: 'Block' },
  ...
  // ─── Flow 13: Security Audit ──────────────────────────────────────────────
  {
    ...
    nodes: [
      ...
      { id: 'sa-gate-impact', nodeType: 'gate',       label: 'Security Impact?', maxRetries: 1,             position: { x: 220, y: 200 } },
      ...
      { id: 'sa-gate-verify', nodeType: 'gate',       label: 'Verify Remed.?',   maxRetries: 2,             position: { x: 880, y: 200 } },
    ...
    edges: [
      { id: 'sa1',  source: 'sa-start',       target: 'sa-gate-impact', edgeKind: 'default' },
      { id: 'sa2',  source: 'sa-gate-impact', target: 'sa-gate-gaps',   edgeKind: 'pass',  label: 'PASS' },
      { id: 'sa3',  source: 'sa-gate-impact', target: 'sa-esc',         edgeKind: 'fail',  label: 'Critical' },
      ...
      { id: 'sa6',  source: 'sa-fix',         target: 'sa-gate-verify', edgeKind: 'default' },
      { id: 'sa7',  source: 'sa-gate-verify', target: 'sa-approval',    edgeKind: 'pass',  label: 'PASS' },
      { id: 'sa8',  source: 'sa-gate-verify', target: 'sa-fix',         edgeKind: 'fail',  label: 'retry' },
