"""
Studio Validator - Language Configuration
...
@cpt-dod:cpt-studio-dod-traceability-validation-code:p1
"""
...
# @cpt-end:cpt-studio-algo-traceability-validation-language-config:p1:inst-lang-datamodel

# @cpt-begin:cpt-studio-algo-traceability-validation-language-config:p1:inst-lang-define-defaults
...
# @cpt-begin:cpt-studio-algo-traceability-validation-language-config:p1:inst-lang-load-config
...
# @cpt-end:cpt-studio-algo-traceability-validation-language-config:p1:inst-lang-load-config
...
# @cpt-begin:cpt-studio-algo-traceability-validation-language-config:p1:inst-lang-build-regex
def build_studio_begin_regex(lang_config: LanguageConfig) -> re.Pattern:
