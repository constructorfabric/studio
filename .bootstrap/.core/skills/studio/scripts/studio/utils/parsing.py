"""
Studio Validator - Markdown Parsing Utilities
...
# @cpt-begin:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-required-sections
def parse_required_sections(requirements_path: Path) -> Dict[str, str]:
    ...
    return sections
# @cpt-end:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-required-sections


# @cpt-begin:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-find-sections
def find_present_section_ids(artifact_text: str) -> List[str]:
    ...
    return present
# @cpt-end:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-find-sections


# @cpt-begin:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-split-sections
...
# @cpt-end:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-split-sections
...
# @cpt-begin:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-field-block
def field_block(lines: List[str], field_name: str) -> Optional[Dict[str, object]]:
    ...
    return None
# @cpt-end:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-field-block
...
# @cpt-begin:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-extract-ids
def extract_backticked_ids(line: str, pattern: re.Pattern) -> List[str]:
    ...
    return ids
# @cpt-end:cpt-studio-algo-traceability-validation-parsing-utils:p1:inst-parse-extract-ids
