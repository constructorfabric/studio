...
@cpt-algo:cpt-studio-algo-workspace-resolve-git-url:p1
@cpt-algo:cpt-studio-algo-workspace-sync-git-source:p1
@cpt-dod:cpt-studio-dod-workspace-git-url-sources:p1
@cpt-dod:cpt-studio-dod-workspace-sync:p1
"""
...
def _redact_url(url: str) -> str:
    ...
    return url
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-datamodel


# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-parse-url
def _parse_git_url(url: str) -> Optional[Tuple[str, str, str]]:
    ...
    for pattern in (_HTTPS_RE, _SSH_URL_RE, _SSH_SHORT_RE):
        ...
        if m:
            ...
            return (host, "", parts[0])
    return None
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-parse-url


# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-lookup-namespace
...
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-apply-template
def _apply_template(template: str, org: str, repo: str) -> str:
    ...
    return result
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-apply-template


# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-clone-or-fetch
...
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-run-command
...
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-run-command


# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-compute-path
def _compute_local_path(
    ...
    return local_path
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-compute-path


# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-determine-branch
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-if-exists-fetch
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-else-clone
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-if-fail
# @cpt-begin:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-return-path
...
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-if-exists-fetch
# @cpt-end:cpt-studio-algo-workspace-resolve-git-url:p1:inst-git-determine-branch


# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-resolve-path
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-no-path
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-not-repo
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-fetch
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-fetch-fail
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-determine-branch
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-head
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-else-branch
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-update-fail
# @cpt-begin:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-return-ok
...
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-return-ok
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-update-fail
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-else-branch
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-head
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-determine-branch
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-fetch-fail
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-fetch
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-not-repo
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-if-no-path
# @cpt-end:cpt-studio-algo-workspace-sync-git-source:p1:inst-sync-resolve-path
