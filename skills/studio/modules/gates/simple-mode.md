...
```pdsl
UNIT SimpleModeGate
PURPOSE: Ask once per session whether Studio should use expanded explanations and whether to separately opt into autonomous defaults.
STATE:
...
RULES:
  ...
  - ALWAYS remember either simple-mode choice for the whole session
