...
OPTIONS:
  ...
  2 browse all generate workflows -> LOAD {cf-studio-path}/.core/skills/studio/modules/generate-skill-fallbacks.md; CONTINUE GenerateOtherSkills
...
OPTIONS:
  ...
  2 describe-intent | help-me-choose (suggested) -> LOAD {cf-studio-path}/.core/skills/studio/modules/generate-intent-capture.md; CONTINUE GenerateDescribeIntent
