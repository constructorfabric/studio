...
STATE:
  SET MANUAL_GUIDANCE_STATUS: valid | invalid | unset (default unset, scope workflow_run)
WHEN:
  REQUIRE PENDING_MANUAL_GUIDANCE == true
DO:
  CONTINUE KitInitManualGuidanceParseAndValidate
  CONTINUE KitInitManualGuidanceHandleInvalid WHEN MANUAL_GUIDANCE_STATUS == invalid
  LOAD {cf-studio-path}/.core/skills/studio/modules/kit-manual-guidance-preview.md
  CONTINUE KitInitManualGuidanceSynthesizePreview WHEN MANUAL_GUIDANCE_STATUS == valid
...
DO:
  ...
  SET MANUAL_GUIDANCE_STATUS = invalid WHEN guidance is invalid
  SET MANUAL_GUIDANCE_STATUS = valid WHEN guidance is valid
