# Write Docs Execution Refs

```pdsl
UNIT WriteDocsExecutionContextPrep
PURPOSE: Load shared execution-time context and resolve document policy dimensions immediately before author or reviewer dispatch.
DO:
