...
DO:
  ...
  RUN verify the references loaded; EMIT "Required review reference not found (code-checklist, bug-finding, or consistency-checklist methodology under {cf-studio-path}/.core) — cannot review code; reinstall or sync the studio kit, then retry." and STOP_TURN WHEN any load fails
```
