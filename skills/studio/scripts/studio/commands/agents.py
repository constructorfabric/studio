...
_GENERATED_MARKER_RE = re.compile(
    r"^<!--\s*Generated by (?:studio|cf) agents\s*--\s*do not edit\s*-->\s*\n?",
    re.MULTILINE,
)
...
_STUDIO_LEGACY_SUBAGENT_GLOBS: Dict[str, List[str]] = {
    "claude":   [".claude/agents/studio-*.md"],
    "cursor":   [".cursor/agents/studio-*.md"],
    "copilot":  [".github/agents/studio-*.agent.md"],
    "openai":   [".codex/agents/studio-*.toml"],
    # windsurf doesn't have a per-tool sub-agent directory convention
    # in studio's generator; nothing to glob here.
}
...
_STUDIO_LEGACY_MARKER_PATHS: Dict[str, List[str]] = {
    "copilot": [".github/.studio-installed"],
    "openai":  [".codex/.studio-installed"],
}
...
def _process_legacy_cleanup(
    ...
    # ── Clean up legacy .studio-installed markers (per-tool) ───────────────
