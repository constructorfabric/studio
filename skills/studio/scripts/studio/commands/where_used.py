...
def cmd_where_used(argv: List[str]) -> int:
    """Find all references to a Studio ID."""
    p = argparse.ArgumentParser(prog="where-used", description="Find all references to an Studio ID")
    p.add_argument("id_positional", nargs="?", default=None, help="Studio ID to find references for")
