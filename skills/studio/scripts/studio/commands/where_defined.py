"""Find where a Studio traceability identifier is defined."""
...
def cmd_where_defined(argv: List[str]) -> int:
    """Find where a Studio ID is defined."""
    p = argparse.ArgumentParser(prog="where-defined", description="Find where an Studio ID is defined")
    p.add_argument("id_positional", nargs="?", default=None, help="Studio ID to find definition for")
    p.add_argument("--id", default=None, help="Studio ID to find definition for")
