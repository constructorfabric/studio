...
@cpt-algo:cpt-studio-algo-ralphex-delegation-discover:p1
@cpt-algo:cpt-studio-algo-ralphex-delegation-validate:p1
"""
...
# @cpt-begin:cpt-studio-algo-ralphex-delegation-validate:p1:inst-if-none
INSTALL_GUIDANCE = (
...
# @cpt-end:cpt-studio-algo-ralphex-delegation-validate:p1:inst-if-none
...
def discover(config: dict) -> Optional[str]:
    ...
    """
    # @cpt-begin:cpt-studio-algo-ralphex-delegation-discover:p1:inst-search-path
    ...
    if persisted and os.path.isfile(persisted):
        ...
        # @cpt-begin:cpt-studio-algo-ralphex-delegation-discover:p1:inst-return-path
        return persisted
        # @cpt-end:cpt-studio-algo-ralphex-delegation-discover:p1:inst-return-path
    # @cpt-end:cpt-studio-algo-ralphex-delegation-discover:p1:inst-verify-persisted

    # @cpt-begin:cpt-studio-algo-ralphex-delegation-discover:p1:inst-return-none
    logger.info("ralphex not found on PATH or in persisted config")
    return None
    # @cpt-end:cpt-studio-algo-ralphex-delegation-discover:p1:inst-return-none
...
def validate(ralphex_path: Optional[str]) -> Dict[str, object]:
    ...
    # @cpt-begin:cpt-studio-algo-ralphex-delegation-validate:p1:inst-run-version
    try:
        proc = subprocess.run(
    ...
    # @cpt-end:cpt-studio-algo-ralphex-delegation-validate:p1:inst-run-version

    # @cpt-begin:cpt-studio-algo-ralphex-delegation-validate:p1:inst-parse-version
    ...
    # @cpt-end:cpt-studio-algo-ralphex-delegation-validate:p1:inst-return-available

    # @cpt-begin:cpt-studio-algo-ralphex-delegation-validate:p1:inst-return-incompatible
    ...
    # @cpt-end:cpt-studio-algo-ralphex-delegation-validate:p1:inst-return-incompatible


# @cpt-begin:cpt-studio-flow-ralphex-delegation-discover:p1:inst-persist-path
def persist_path(config_path: Path, ralphex_path: str) -> None:
    ...
    toml_utils.dump(data, config_path, header_comment="Constructor Studio project configuration")
    logger.info("Persisted ralphex path to %s", config_path)
# @cpt-end:cpt-studio-flow-ralphex-delegation-discover:p1:inst-persist-path
