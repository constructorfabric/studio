...
**ALWAYS open and follow**: `{cf-studio-path}/.core/architecture/specs/CDSL.md` WHEN specifying behavioral sections in root DESIGN.md

**ALWAYS open and follow**: `{cf-studio-path}/.core/architecture/specs/CDSL.md` WHEN specifying behavioral sections in spec DESIGN.md
