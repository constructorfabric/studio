...
**ID**: `cpt-studio-adr-git-style-conflict-markers`
...
- **PRD**: `cpt-studio-fr-core-resource-diff`
- **DESIGN**: `cpt-studio-component-kit-manager`, Resource Diff Engine
- **Related**: `cpt-studio-adr-remove-blueprint-system` (ADR-0001, file-level diff replaces three-way merge)
