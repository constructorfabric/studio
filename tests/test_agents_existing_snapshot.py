...
class TestExistingAgentsSnapshot(unittest.TestCase):
    ...
    def test_tuning_table_exact_values(self):
        ...
        agents = self._load_agents()
        expected = {
            "cf-codegen":          ("generate", "codebase", "low",    "high"),
            "cf-pr-review":        ("analyze",  "any",      "high",   "high"),
            "cf-ralphex":          ("any",      "any",      "medium", "medium"),
            "cf-phase-runner":     ("generate", "any",      "low",    "high"),
            "cf-phase-compiler":   ("planning", "artifacts","low",    "medium"),
            "cf-phase-runner-isolated":   ("generate", "any",      "low",    "high"),
            "cf-phase-compiler-isolated": ("planning", "artifacts","low",    "medium"),
            ...
            "cf-pdsl-author":       ("generate", "any",      "medium", "high"),
            "cf-pdsl-transformer":  ("generate", "any",      "medium", "high"),
            ...
            "cf-generate-author-middle":      ("generate", "any",      "low",    "high"),
            "cf-generate-author-senior":      ("generate", "any",      "medium", "high"),
            "cf-generate-author-lead":        ("generate", "any",      "high",   "high"),
            "cf-generate-coder-casual":       ("generate", "codebase", "low",    "medium"),
            "cf-generate-coder-smart":        ("generate", "codebase", "medium", "high"),
            "cf-generate-prompt-engineer-casual": ("generate", "any",  "low",    "medium"),
