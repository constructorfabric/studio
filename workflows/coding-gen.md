...
DO:
  ...
  EMIT a completed SKILL_RESULT envelope with skill = cf-coding-gen, status = completed, produced_artifacts = code-changes summarizing the authored workspace diff or returned change scope, report_outputs = [], missing_artifacts = [], assumptions = [], and suggested_next_skills = []
