...
DO:
  ...
  EMIT "Note: each phase in this plan requires (1) authoring, (2) CI validation, (3) semantic review, (4) git commit prep, and (5) phase close. For a lightweight iteration without git and phase-close steps, set PHASE_CHECKLIST_CONTRACT git required false and phase-close required false before invoking this workflow."
