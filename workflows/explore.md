...
OPTIONS:
  ...
  4 saved-context -> Continue saved context — reply with a path to a saved exploration bundle (its result.json) or a prior session reference; LOAD it as resource_context, then CONTINUE ExploreRun
