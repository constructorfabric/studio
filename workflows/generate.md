...
```pdsl
UNIT GenerateRootSkillEntrypointBootstrap
...
RULES:
  ...
  - ALWAYS include ORIGINAL_INTENT in every author and validator dispatch payload as task context
