...
```pdsl
UNIT HelpPresetStorytellingSession
PURPOSE: Set the fixed storytelling session flags for the help preset.
DO:
...
```pdsl
UNIT HelpPresetStorytellingGoal
PURPOSE: Set the remaining storytelling defaults and the help-session goal.
DO:
