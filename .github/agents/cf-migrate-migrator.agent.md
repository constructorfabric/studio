...
Constructor Studio endpoint only. Prompt source: {cf-studio-path}/.core/skills/studio/agents/cf-migrate-migrator.md. Final prompt is supplied by the cf controller at dispatch time.
